...
const CustomPrevArrow = (props: any) => {
  ...
  return (
    <div className="slider-arrow text-lg-end mb-20">
      <button onClick={onClick} type="button" className="feature-prev">
...
const CustomNextArrow = (props: any) => {
  ...
  return (
    <div className="slider-arrow text-lg-end mb-20">
      <button onClick={onClick} type="button" className="feature-next">
              ...
              <div className="row justify-content-between">
                <div className="col-lg-8">
                  <div className="section-title mb-35">
                    ...
                    <p>
                      You can make a difference in the lives of others by making
                      a donation. Your donation will help provide food, shelter,
                      and education to those in need. You can also volunteer
