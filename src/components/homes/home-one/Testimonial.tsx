...
const Testimonial = () => {
  ...
  return (
    <div
      className="testimonials-area bgc-black bgs-cover py-120"
      style={{
        backgroundImage: `url(/assets/img/testimonials/testimonial-bg.png)`,
      }}
    >
            ...
            <div className="testimonial-left-image rmb-65">
              <Image
                src={
                  // testimonialImg_1
                  {
                    src: "https://source.unsplash.com/517x610/?professional,john,avatar",
                    width: 517,
                    height: 610,
                  }
                }
              ...
              <div className="testimonial-thumb-item">
                <Image
                  src={
                    //   testimonialThumb_1,
                    {
                      src: "https://source.unsplash.com/100x100/?heart,icon",
                      width: 65,
                      height: 64,
                    }
                  }
