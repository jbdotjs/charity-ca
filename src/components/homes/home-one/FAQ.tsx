                ...
                <div className="col-6">
                  <div className="image">
                    <Image
                      src={
                        ...
                        {
                          // 305x418
                          src: "https://source.unsplash.com/305x418/?helping-hands",
                          width: 305,
                          height: 418,
                        }
                      }
                  ...
                  <div className="image">
                    <Image
                      ...
                      src={{
                        //   305x292
                        src: "https://source.unsplash.com/305x229/?helping",
                        width: 305,
                        height: 229,
                      }}
                      alt="About"
                ...
                <div className="col-6">
                  <div className="image">
                    <Image
                      ...
                      src={{
                        //   305x292
                        src: "https://source.unsplash.com/305x292/?hope",
                        width: 305,
                        height: 292,
                      }}
                      alt="About"
                  ...
                  <div className="image">
                    <Image
                      ...
                      src={{
                        //   305x292
                        src: "https://source.unsplash.com/305x229/?children",
                        width: 305,
                        height: 292,
                      }}
                      alt="About"
          ...
          <div className="col-lg-6">
            <div className="faq-content-part rmt-65 rel z-2">
              <div className="section-title mb-45 for-hide-summary">
                ...
                <p>
                  We are here to help you. If you have any questions, please
                  feel free to ask.
                </p>
              </div>
